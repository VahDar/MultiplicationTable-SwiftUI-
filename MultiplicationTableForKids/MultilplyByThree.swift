...
struct MultilplyByThree: View {
    ...
    @State private var multiplyNumber = 3
    ...
    func generateAnswers() {
        ...
        for _ in 0...2 {
            answerList.append(Int.random(in: 3...60))
        }
...
struct MultilplyByThree_Previews: PreviewProvider {
