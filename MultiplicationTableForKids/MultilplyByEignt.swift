...
struct MultilplyByEignt: View {
    ...
    @State private var multiplyNumber = 8
    ...
    func generateAnswers() {
        ...
        for _ in 0...2 {
            answerList.append(Int.random(in: 8...160))
        }
...
struct MultilplyByEignt_Previews: PreviewProvider {
