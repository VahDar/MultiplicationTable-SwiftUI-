...
struct MultilplyByFour: View {
    ...
    @State private var multiplyNumber = 4
    ...
    func generateAnswers() {
        ...
        for _ in 0...2 {
            answerList.append(Int.random(in: 4...80))
        }
...
struct MultilplyByFour_Previews: PreviewProvider {
