...
struct MultilplyByNine: View {
    ...
    @State private var multiplyNumber = 9
    ...
    func generateAnswers() {
        ...
        for _ in 0...2 {
            answerList.append(Int.random(in: 9...180))
        }
...
struct MultilplyByNine_Previews: PreviewProvider {
