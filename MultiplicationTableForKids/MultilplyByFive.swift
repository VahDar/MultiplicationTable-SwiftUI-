...
struct MultilplyByFive: View {
    ...
    @State private var multiplyNumber = 5
    ...
    func generateAnswers() {
        ...
        for _ in 0...2 {
            answerList.append(Int.random(in: 5...100))
        }
...
struct MultilplyByFive_Previews: PreviewProvider {
