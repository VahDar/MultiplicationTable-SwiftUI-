...
struct MultilplyBySix: View {
    ...
    @State private var multiplyNumber = 6
    ...
    func generateAnswers() {
        ...
        for _ in 0...2 {
            answerList.append(Int.random(in: 6...120))
        }
...
struct MultilplyBySix_Previews: PreviewProvider {
