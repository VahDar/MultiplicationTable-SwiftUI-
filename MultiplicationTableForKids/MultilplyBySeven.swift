...
struct MultilplyBySeven: View {
    ...
    @State private var multiplyNumber = 7
    ...
    func generateAnswers() {
        ...
        for _ in 0...2 {
            answerList.append(Int.random(in: 7...140))
        }
...
struct MultilplyBySeven_Previews: PreviewProvider {
